...
<html lang="ru">
  ...
  <body class="front-page">
        ...
        <div class="cards">
          <a href="#" class="card">
            ...
            <picture>
              ...
              <source type="image/jpeg" srcset="img/avtohim.jpeg">
          ...
          <a href="#" class="card">
            ...
            <picture>
              <source type="image/webp" srcset="img/bithim.webp">
              <source type="image/jpeg" srcset="img/bithim.jpeg">
          ...
          <a href="#" class="card">
            ...
            <picture>
              ...
              <source type="image/jpeg" srcset="img/dezinfect.jpeg">
              <img src="img/dezinfect.png" alt="Дезинфицирующая химия" class="card-image" />
            </picture>
          </a>
          <a href="#" class="card">
            <div class="card-content">
    ...
    <section class="section founder">
      <picture>
        <source type="image/webp" srcset="img/founderbg.webp">
        <source type="image/jpeg" srcset="img/founderbg.jpeg">
        <img src="img/founderbg.png" alt="Основатель" class="founder-photo" />
      </picture>
      <div class="container">
          ...
          <div class="clients-logo-list">
            <div class="clients-logo-item">
              <picture>
                ...
                <source type="image/jpeg" srcset="img/client.jpeg">
                <img src="img/client.jpeg" alt="Клиент" class="clients-logo" />
              </picture>
            </div>
        ...
        <div class="swiper blog-slider">
          ...
          <div class="swiper-wrapper">
            ...
            <a href="#" class="swiper-slide blog-card">
              <picture>
                <source type="image/webp" srcset="img/blog/BlogImage1.webp">
                <source type="image/jpeg" srcset="img/blog/BlogImage1.png">
                <img src="img/blog/BlogImage1.png" alt="Блог" class="blog-card-image" />
              </picture>
            ...
            <a href="#" class="swiper-slide blog-card">
              <picture>
                <source type="image/webp" srcset="img/blog/BlogImage2.webp">
                <source type="image/jpeg" srcset="img/blog/BlogImage2.png">
                <img src="img/blog/BlogImage1.png" alt="Блог" class="blog-card-image" />
              </picture>
              <h3 class="blog-card-title">
